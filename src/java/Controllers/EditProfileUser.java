...
public class EditProfileUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("em",u.getEmail());
        request.setAttribute("pnum", u.getPhone());
        request.setAttribute("ava", u.getAvatar());
    ...
    throws ServletException, IOException {
        ...
        ud.updateUser(username,fullname, email, phone, avatar);
