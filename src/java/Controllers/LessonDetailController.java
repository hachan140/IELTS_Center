...
public class LessonDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("lesson", ld.getLessonByLessonId(lessonId));
    ...
    throws ServletException, IOException {
        ...
        StudentProgress sp = (StudentProgress)ses.getAttribute("erolledSCourse");
        

        
        LessonProgressDAO lpd = new LessonProgressDAO();
        lpd.addLessonProgress(sp.getUsername(), sp.getCourseId(), lessonId);
        StudentProgressDAO spd = new StudentProgressDAO();
        
        spd.updateStudentProgress(sp.getUsername(), sp.getCourseId());
        response.sendRedirect("/FinalEdit/lesson?cid=" + sp.getCourseId());
